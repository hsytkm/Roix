...
");
  if (HasFlag(RoixStructGeneratorOptions.TypeInt)) { 
            this.Write("            var oldValue = (");
            this.Write(this.ToStringHelper.ToStringWithCulture(GetRoixNameWithoutInt()));
            this.Write(")this;\r\n            var x1 = oldValue.Value * ((RoixSize)newBorder / oldValue.Bor" +
                    "der);\r\n            var x2 = new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(GetRoixNameWithoutInt()));
            this.Write("(x1, (RoixSize)newBorder);\r\n            return new(((");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            this.Write(")x2).Value, newBorder);\r\n");
  } else { 
            this.Write("            return new(this.Value * (newBorder / this.Border), newBorder);\r\n");
  } 
            this.Write("        }\r\n");
  if (HasFlag(RoixStructGeneratorOptions.TypeInt)) { 
            this.Write("        public ");
            ...
            this.Write(@" ConvertToNewBorder(in RoixSize newBorder)
        {
            ...
            var value = (");
            this.Write(this.ToStringHelper.ToStringWithCulture(GetRoixNameWithoutInt()));
            this.Write(")this;\r\n            return new(value.Value * (newBorder / value.Border), newBorde" +
                    "r);\r\n        }\r\n");
  } 
            this.Write("\r\n");
 } 
